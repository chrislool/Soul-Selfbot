...
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Welcome To"+Fore.RED+" Soul "+Fore.WHITE+"Selfbot!")
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Version: "+Fore.RED+"1.0.1")
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Developer("+Fore.RED+"s"+Fore.WHITE+"): "+Fore.RED+"0ˢᵒᵘˡˢ#1337")
...
async def on_ready():
            ...
            print(Style.BRIGHT + Fore.RED + Back.BLACK +"                                      ║"+ Style.BRIGHT + Fore.WHITE + Back.BLACK + "          Discord     "+ Style.BRIGHT + Fore.RED + Back.BLACK + "║")
            print(Style.BRIGHT + Fore.RED + Back.BLACK +"                                      ╠═══════════════════════════════╣")
            print(Style.BRIGHT + Fore.RED + Back.BLACK +"                                      ║ "+ Style.BRIGHT + Fore.WHITE + Back.BLACK +"      0ˢᵒᵘˡˢ#1337        "+ Style.BRIGHT + Fore.RED + Back.BLACK +"║")
            print(Style.BRIGHT + Fore.RED + Back.BLACK +"                                      ║ "+ Style.BRIGHT + Fore.WHITE + Back.BLACK +"  twitch.com/soulsontop  "+ Style.BRIGHT + Fore.RED + Back.BLACK +"║")
            print(Style.BRIGHT + Fore.RED + Back.BLACK +"                                      ╚═══════════════════════════════╝")
...
async def on_message(message):s
    global prefix 
    prefix =s
    if message.author == client.user:16ˢᵒᵘˡˢ#1359
        commands = [s]
        z =
        for index, a in enumerate(message.content)::
            if a == "": 
                commands.append(message.content[:index])
                z = index + 1
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"help":
            ...
            container = discord.Embed(title="__**Soul Selfbot**__", colour=0xFF0400)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
            container.set_author(name="Developed By 0souls", icon_url="https://i.imgur.com/5bd3F42.png")
            ...
            container.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"messages":
                ...
                await message.delete()
                container = discord.Embed(title="__**Soul Selfbot Message List**__", color=0xFF0400)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"stattools":
            ...
            await message.delete()
            container = discord.Embed(title="__**Soul Selfbot StatTool List**__", color=0xFF0400)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
            ...
            container.add_field(name="**Stream Status Changer**", value="Usage:"+prefix+"stream [QUOTEDWORD] [LINK]", inline=False)
        ...
        # Streaming $INPUT
        if commands[0] == ""+prefix+"stream":
                if len(commands) <= 3:
                        msg = message.content.split(""+prefix+"stream ", 1)
                        ...
                        await message.delete()
                        container = discord.Embed(title="__**Status Tool**__", color=0xFF0400)
                        container.add_field(name="**Usage:**", value=""+prefix+"stream [name] [url]")
                        container.add_field(name="**Example:**", value=""+prefix+"stream 'video game' https://twitch.tv/streamer", inline=False)
                        container.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
                        await channel.send(embed=container)
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"terminal":
            ...
            await message.delete()
            container = discord.Embed(title="__**Soul Selfbot Terminal List**__", color=0xFF0400)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
        ...
        if commands[0] == ""+prefix+"stop":
            ...
            print("Time Left: 1")
            time.sleep(1)
            print("Shutting Down! - Made By 0ˢᵒᵘˡˢ#1337")
            sys.exit()
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"ddos":
            ...
            if len(commands) == 2 and commands[1] == "methodlist":
                ...
                await message.delete()
                container = discord.Embed(title="__**Soul Selfbot Attack API**__", color=0xFF0400)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"menutools":
            ...
            await message.delete()
            container = discord.Embed(title="__**Soul Selfbot Menu Tool List**__", color=0xFF0400)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/640702110819811338/646075433779068928/Spamtec.png")
        ...
        if commands[0] == ""+prefix+"logging":
            ...
            if len(commands) == 2:
                if commands[1] == "on":
                    ...
                    container0.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
                    ...
                    container1.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
                    ...
                    if logging_enabled == True:
                        ...
                        container2.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337;", icon_url="https://i.imgur.com/5bd3F42.png")
                        ...
                        container3.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
                ...
                if len(commands) == 2:
                        ...
                        for sub in subdomains:
                                try:
                                        ...
                                        pass
                        containerA.set_footer(text="Made By 0ˢᵒᵘˡˢ#1337", icon_url="https://i.imgur.com/5bd3F42.png")
